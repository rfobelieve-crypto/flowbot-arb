@echo off
REM AERO - HMM candidate, generated from measurements (2026-09-14).
REM CLI --symbol is the HL leg (AERO); the Lighter leg (AERO)
...
:loop
python main.py --shadow --symbol AERO --hedge lighter --config config_AERO.yaml --no-dashboard >> logs\AERO\runner.log 2>&1
