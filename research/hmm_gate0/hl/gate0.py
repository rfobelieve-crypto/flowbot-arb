# -*- coding: utf-8 -*-
# 2026-09-15 從 flow_system/research/hl/gate0.py 複製（使用者：全部複製過去），原檔仍在原處
...
——真實值還要加簽章、風控、撮合。**不得把下界當成實測值引用。**
    ...
    python research/hmm_gate0/hl/gate0.py
"""
...
OUT = ROOT / "research" / "hmm_gate0" / "results" / "hl_gate0.json"
