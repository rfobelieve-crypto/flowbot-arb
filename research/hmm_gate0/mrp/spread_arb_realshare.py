# -*- coding: utf-8 -*-
# 2026-09-15 從 flow_system/research/mrp/spread_arb_realshare.py 複製（使用者：全部複製過去），原檔仍在原處
...
ROOT = os.path.dirname(os.path.dirname(os.path.dirname(HERE)))  # arb 根目錄（原本是 flow_system 根目錄）
sys.path.insert(0, HERE)
sys.path.insert(0, ROOT)

PAIRS = os.path.join(ROOT, "research", "hmm_gate0", "results", "spread_arb_pairs.json")
FLOW = os.path.join(ROOT, "research", "hmm_gate0", "results", "lighter_flow_gate0.json")
