# -*- coding: utf-8 -*-
# 2026-09-15 從 flow_system/research/mrp/lighter_flow_gate0.py 複製（使用者：全部複製過去），原檔仍在原處
...
OUT = os.path.join(ROOT, "research", "hmm_gate0", "results", "lighter_flow_gate0.json")
