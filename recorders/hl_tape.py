# -*- coding: utf-8 -*-
# 2026-09-15 從 flow_system/research/hl/hl_tape.py 搬到 arb/recorders/（使用者：四支全搬）。D: 上的資料路徑沒變；旗標與鎖檔改在 arb/results/。
...
跑法
===========================================================================
    python recorders/hl_tape.py                  常駐
    python recorders/hl_tape.py --seconds 120    跑一段就停（驗收用）
"""
...
ROOT = HERE.parents[0]   # arb 根目錄（2026-09-15 從 flow_system/research/hl/hl_tape.py 搬來）
TAPE_DIR = Path(os.environ.get("HL_TAPE_DIR", r"D:\flowbot_data\hl\trades"))
ADDR_TAPE = HERE / "data" / "addresses_tape.json"
FLAG = ROOT / "results" / "hl_tape_last.json"
