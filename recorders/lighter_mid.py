# -*- coding: utf-8 -*-
# 2026-09-15 從 flow_system/research/lighter/lighter_mid.py 搬到 arb/recorders/（使用者：四支全搬）。D: 上的資料路徑沒變；旗標與鎖檔改在 arb/results/。
...
跑法
===========================================================================
    python recorders/lighter_mid.py                  常駐
    python recorders/lighter_mid.py --seconds 60     跑一段就停（驗收）
    LIGHTER_MID_SAMPLE_SEC=60 python recorders/lighter_mid.py   回到 60 秒
    python recorders/lighter_mid.py --top 40         縮小宇宙
"""
...
ROOT = HERE.parents[0]   # arb 根目錄（2026-09-15 從 flow_system/research/lighter/lighter_mid.py 搬來）
MID_DIR = Path(os.environ.get("LIGHTER_MID_DIR",
                              r"D:\flowbot_data\lighter\mid"))
FLAG = ROOT / "results" / "lighter_mid_last.json"
LOCK = ROOT / "results" / ".lighter_mid.lock"
