# -*- coding: utf-8 -*-
# 2026-09-15 從 flow_system/research/hl/hl_mid.py 搬到 arb/recorders/（使用者：四支全搬）。D: 上的資料路徑沒變；旗標與鎖檔改在 arb/results/。
...
===========================================================================
    ...
    python recorders/hl_mid.py                 常駐
    python recorders/hl_mid.py --seconds 120   跑一段就停（驗收用）
"""
...
ROOT = HERE.parents[0]   # arb 根目錄（2026-09-15 從 flow_system/research/hl/hl_mid.py 搬來）
MID_DIR = Path(os.environ.get("HL_MID_DIR", r"D:\flowbot_data\hl\mid"))
FLAG = ROOT / "results" / "hl_mid_last.json"
